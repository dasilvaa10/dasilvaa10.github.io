...
![](blog1_ver2_2md_files/figure-markdown_github/unnamed-chunk-2-1.png)
...
We'll first start by finding our beta coefficients. In order to do this, we need to take the inverse of X transpose X and multiply that by X tranpose Y. Put more readably: *b* = (*X*<sup>*T*</sup>*X*)<sup>−1</sup>*X*<sup>*T*</sup>*Y*. Below, we'll begin by creating our *X*<sup>*T*</sup>*X* and *X*<sup>*T*</sup>*Y* matrices.
...
![](blog1_ver2_2md_files/figure-markdown_github/unnamed-chunk-9-1.png)
...
![](blog1_ver2_2md_files/figure-markdown_github/unnamed-chunk-10-1.png)
